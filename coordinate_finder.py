...
def sort1(sub_li):
    ...
    if(l==4):
    #sorting according to x coordinates that are at the same y level
    # can be done for more than 4 vertieces
...
def read_images():
    ...
    # gives the coordinates of the polygon after processing for differnet color
    ...
    count = 0
    # only considering quadrilateral shapes
    ...
    return coordinates_final, coordinates_game, coordinates_calc
    # cv2.waitKey(0)
